...
<section class="bg-gray-100 pb-10 pt-20">
	<div class="mx-auto max-w-6xl px-4">
		<div class="form-container">
			<div
				class="flex items-center justify-center text-3xl font-bold self-center pt-10 text-center"
			>
				<p>{nama_acara}</p>
			</div>
			<div class="grid grid-cols-1 gap-8 px-10 py-10 md:grid-cols-2">
				...
				<div>
					...
					<div class="mt-8 flex items-center">
						<button
							class=" w-full h-fit px-2 py-3 border-2 border-red-400 bg-red-400 text-white text-center rounded-full"
						>
