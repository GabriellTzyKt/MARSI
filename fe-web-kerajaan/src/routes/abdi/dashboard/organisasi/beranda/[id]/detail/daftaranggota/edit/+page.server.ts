...
export const actions: Actions = {
    edit: async ({ request }) => {
        ...
        const ver = z.object({
            ...
            // hobi: z.string().trim().min(1, "Isi hobi!"),
            ...
            // pekerjaan: z.string().trim().min(1, "Isi Pekerjaan!"),
            // agama: z.string().trim().min(1, "Isi Agama!"),
            // email: z.string().email("Email Tidak Valid").trim().min(1, "Email harus diisi!"),
