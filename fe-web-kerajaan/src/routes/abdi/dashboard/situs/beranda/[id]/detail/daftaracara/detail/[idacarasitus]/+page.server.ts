...
export const load: PageServerLoad = async ({ params, cookies }) => {
    let id_acara = params.idacarasitus
    let id_situs = params.id
    ...
    try {
        ...
        if (res.ok && resUndangan.ok && resPanit.ok && resSitus.ok) {
            ...
            return { data: formattedData,id_situs,id_acara, undangan: undanganWithUser, panit: panitWithUser, situs: situs };
        }
    }
    catch (e) {
