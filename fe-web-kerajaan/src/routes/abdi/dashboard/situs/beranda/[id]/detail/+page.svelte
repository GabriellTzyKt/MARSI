...
<div class="h-full w-full">
	<div class="block h-fit rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
		<div class="relative mx-auto flex w-full items-center justify-center">
			<img
				src={datafotoprofil?.url || gambardefault}
		...
		<div class="mt-10 grid grid-cols-1 gap-4 lg:grid-cols-3">
			...
			<div class="grid-cols-5">
				...
				>
					...
					<input
						type="text"
						bind:value={dataambil.nama_situs}
						readonly
				...
				>
					...
					<input
						type="text"
						bind:value={data.wisata.nama_wisata}
						readonly
				...
				>
					<p>Deskripsi Situs :</p>
					<textarea bind:value={dataambil.deskripsi_situs} readonly placeholder="Masukkan Email"
					></textarea>
				</div>
			</div>
			...
			<div class="grid-cols-5">
				...
				>
					...
					<input
						type="text"
						bind:value={dataambil.nama_pendiri}
						readonly
						placeholder="Masukkan Nama"
					/>
				</div>
				...
				>
					<p>Pembina :</p>
					<input type="text" bind:value={data.pembina} readonly placeholder="Masukkan Alamat" />
				</div>
				<div
					class="mt-5 flex h-fit flex-col rounded-lg border border-gray-200 bg-white px-3 py-2 shadow-sm"
				>
					<p>Juru Kunci :</p>
					<input type="text" bind:value={data.juru_kunci} readonly placeholder="Masukkan Email" />
				</div>
				<div
					class="mt-5 flex h-fit flex-col rounded-lg border border-gray-200 bg-white px-3 py-2 shadow-sm"
				>
			...
			<div class="grid-cols-5">
				...
				>
					...
					<input
						type="text"
						bind:value={dataambil.tahun_berdiri}
						readonly
						placeholder="Masukkan Nama"
					/>
				</div>
				...
				>
					<p>Pelindung :</p>
					<input type="text" bind:value={data.pelindung} readonly placeholder="Masukkan Alamat" />
				</div>
				<div
					class="mt-5 flex h-fit flex-col rounded-lg border border-gray-200 bg-white px-3 py-2 shadow-sm"
				>
					<p>Jenis Situs :</p>
					<input type="text" bind:value={situs} readonly placeholder="Masukkan Email" />
				</div>
				<div
					class="mt-5 flex h-fit flex-col rounded-lg border border-gray-200 bg-white px-3 py-2 shadow-sm"
				>
					...
					<input
						type="text"
						bind:value={dataambil.jam_tutup}
						readonly
						placeholder="Masukkan Email"
					/>
				</div>
				...
				>
					...
					<input
						type="text"
						bind:value={dataambil.pemilik_situs}
						readonly
						placeholder="Masih Kosong"
					/>
				</div>
