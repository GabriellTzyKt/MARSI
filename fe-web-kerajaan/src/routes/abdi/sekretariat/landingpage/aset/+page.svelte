	...
	<div class="mt-4 w-full rounded-lg bg-gray-400">
		...
		<div class="flex flex-col rounded-xl border border-gray-500 p-4 pb-6">
			...
			<div class="my-4 flex w-full flex-col">
				...
				<div class=" flex max-h-40 w-full max-w-full gap-3 overflow-x-auto whitespace-nowrap">
					<div class="flex h-32 min-w-40 max-w-full shrink-0">
						<label
					...
					{#each files as file, i}
						...
						<div class="relative flex h-32 min-w-40 shrink-0">
							...
							<div
								class="absolute right-12 top-2 rounded-xl bg-yellow-500 p-2"
								onclick={() => rmfile(i)}
							>
								<input
									type="file"
