...
<div class="h-full w-full">
	<div class="block h-fit rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
		...
		<div class="mt-5 flex w-full">
			<p class="ml-10 w-full text-center font-bold">Dokumentasi</p>
		...
		<div class="mt-5 grid grid-cols-4 gap-2">
			<div class="relative">
				...
				<span
					class="absolute bottom-0.5 right-2 flex h-10 w-10 items-center justify-center rounded-full bg-red-400 p-2"
				>
					<i class="gg--trash absolute bottom-0.5 right-1 z-10 items-center text-2xl text-white"
					></i>
				</span>
			</div>
			<div class="relative">
