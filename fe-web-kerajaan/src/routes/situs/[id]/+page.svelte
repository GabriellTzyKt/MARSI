<script lang="ts">
	...
	const id = situs.id;
	const pendiri = situs.pendiri;
	const pemilik = situs.pemilik;
	const nama = situs.nama_tempat;
	const tahun = situs.tahun_berdiri;
	const lokasi = situs.lokasi;
	const isi = situs.isi;
	const jam_operasi = situs.jam_buka;
	const jenis_tempat = situs.jenis_tempat;
				...
				<div>
					<div class="mt-5 flex items-center">
						...
						<div class="text-md flex-col text-start">
							<p class="ml-4">Dibangun oleh : {pendiri}</p>
							<p class="ml-4">Tahun berdiri : {tahun}</p>
						</div>
					</div>

					<div class="mt-5 flex items-center">
						<span class="mdi--clock flex-shrink-0"></span>
						<p class="text-md ml-4">Jam Buka : {jam_operasi}</p>
					</div>

					<div class="mt-5 flex items-center">
						<span class="tabler--key-filled flex-shrink-0"></span>
					...
					<div class="mt-5 flex items-center">
						...
						<p class="text-md ml-5">{jenis_tempat}</p>
					</div>
