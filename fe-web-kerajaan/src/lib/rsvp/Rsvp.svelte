...
<div class="mb-4 flex h-auto flex-col rounded-lg border-2 border-gray-300 bg-white p-4 shadow-sm">
	...
	<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
		...
		<div class="flex flex-col">
            ...
            />-->
			<input type="text" name={`tamu_nama_${index}`} class="rounded-lg border-2 px-2 py-2" id="" />
			...
			{#if errors[`tamu_nama_${index}`]}
				<p class="mt-1 text-left text-sm text-red-500">- {errors[`tamu_nama_${index}`]}</p>
			{/if}
		</div>
		...
		<div class="flex flex-col">
			...
			<select
				...
				class="rounded-lg border-2 bg-gray-100 px-2 py-2"
			...
			{#if errors[`tamu_jeniskelamin_${index}`]}
				<p class="mt-1 text-left text-sm text-red-500">- {errors[`tamu_jeniskelamin_${index}`]}</p>
			{/if}
		</div>
	</div>
	...
	<div class="mt-4 flex flex-col">
		...
		{#if errors[`tamu_telepon_${index}`]}
			<p class="mt-1 text-left text-sm text-red-500">- {errors[`tamu_telepon_${index}`]}</p>
		{/if}
	</div>
