...
<div class="flex min-h-screen flex-col">
    <div class="w-100 relative mt-3 min-h-fit rounded-lg border-2 border-gray-500 p-3 lg:ml-5">
        <div class="flex flex-col">
            ...
            <div class="w-full justify-end flex mt-2">
                <button class="w-40 mr-5 py-1 rounded-lg border-2 text-white text-nowrap bg-green-500">
                    Tambah Anggota
                </button>
            </div>
