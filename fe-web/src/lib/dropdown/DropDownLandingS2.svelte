<script lang="ts">
    ...
    let { files = $bindable([]), judulSection, name_header, name_deskripsi, name_gambar } = $props();
...
<div class="me-4 ms-4">
    ...
    {#if value}
        <div class="flex flex-col rounded-b-xl border-x border-b border-gray-500 bg-white p-4 pb-6" transition:slide={{ duration: 150 }}>
            ...
            <div class="my-4 flex w-full flex-col items-center justify-center">
                ...
                <div class="flex max-h-40 max-w-[200px] gap-3 overflow-x-auto whitespace-nowrap lg:max-w-[1050px]">
                    <!-- Input file -->
                    <div class="flex h-32 min-w-40 shrink-0">
                        <label class="relative flex h-auto w-full items-center justify-center rounded-xl bg-gray-500">
                            <input
                                type="file"
                                name={name_gambar}
                    ...
                    {#each filePreviews as file, i}
                        <div class="relative flex h-32 min-w-40 shrink-0">
                            ...
                            <div class="absolute right-2 top-2 rounded-xl bg-red-500 p-2" onclick={() => rmfile(i)}>
