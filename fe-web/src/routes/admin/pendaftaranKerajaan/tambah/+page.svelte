...
<div class="ml-2 flex h-fit w-full flex-col md:ml-6">
	...
	<div class="flex flex-col gap-1">
		...
		<div class="flex lg:flex-row flex-col flex-grow gap-2">
			<div class="lg:w-2/4 w-full flex-col">
				<label class="text-md self-start text-left" for="nomor_telepon">Provnsi Kerajaan</label>
				<select
					bind:value={provinsi}
			...
			<div class="w-full flex-col">
				<label class="text-md mt-5 self-start text-left" for="nama"> Lokasi Kerajaan </label>
        ...
        <div class="flex lg:flex-row flex-col flex-grow gap-4">
			...
			<div class="w-full flex-col">
				<label class="text-md self-start text-left" for="nomor_telepon">Era Kerajaan</label>
				<select
					bind:value={era}
					class="h-[40px] w-full rounded-lg border-2 border-gray-400 bg-white py-2 text-left text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
				>
            ...
            <div class="w-full flex-col">
				<label class="text-md self-start text-left" for="nomor_telepon">Rumpun Kerajaan</label>
				<select
					bind:value={rumpun}
					class="h-[40px] w-full rounded-lg border-2 border-gray-400 bg-white py-2 text-left text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
				>
        ...
        <div class="flex lg:flex-row flex-col flex-grow gap-2">
			<div class="lg:w-2/4 w-full flex-col">
				<label class="text-md self-start text-left" for="nomor_telepon">Jenis Kerajaan</label>
				<select
		...
		<div class="mt-2 flex flex-grow flex-col gap-4 md:flex-row">
			<!-- Dokumen -->
			<div class="flex lg:w-2/3 w-full flex-col gap-1">
			...
			<!-- Bendera -->
			<div class="lg:w-1/3 w-full flex-col">
				<p class="text-nowrap lg:text-start text-center">Bendera Kerajaan</p>
				<div
					class="upload-container lg:ml-0 ml-6 relative mt-2 h-[200px] w-[270px] flex-shrink-0 rounded-lg border bg-gray-200 hover:bg-black"
				>
					<input
						type="file"
						id="fileBendera"
        ...
        <button class="bg-customGold px-5 py-2 rounded-lg lg:self-end self-center text-white font-bold lg:mt-0 mt-5" onclick={setTimer}> Daftarkan </button>
