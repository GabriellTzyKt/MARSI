...
<section class="relative w-full">
	<div class="relative">
		<img src={acara.gambartop} alt="" class="min-w-screen min-h-screen object-cover" />
	...
	<div class="edit">
		<div class="form-container absolute mx-auto px-4 lg:mb-20">
			<div class="grid grid-cols-1 gap-8 md:grid-cols-2">
				<div>
					<img src={acara.gambar1} class="h-auto w-full rounded-lg object-cover" alt="" />
					{#if acara.lagu == ''}
						<div class="mt-4 flex justify-center gap-1 lg:gap-4">
							<span class="material-symbols--arrow-circle-left-rounded self-center"></span>
							<img src={acara.gambar2} class="h-16 w-auto rounded-lg object-cover lg:h-24" alt="" />
							<img src={acara.gambar3} class="h-16 w-auto rounded-lg object-cover lg:h-24" alt="" />
							<img src={acara.gambar4} class="h-16 w-auto rounded-lg object-cover lg:h-24" alt="" />
				...
				<div>
					...
					<div class="mt-5 flex items-center">
						...
						<p class="ml-2 items-center text-start">Jenis Aset : {acara.aset}</p>
					</div>
					...
					<div class="mt-5 flex items-center">
						...
						<p class="ml-2 items-center text-start">Kepemilikan : {acara.kepemilikan}</p>
					</div>

					<p class="mt-3 text-start text-sm">{acara.isi}</p>
				</div>
			</div>
		</div>
	</div>
